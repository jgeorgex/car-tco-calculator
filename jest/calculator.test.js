...
test('calulates monthly cost with all inputs car has 0 depreciation', () => {
  expect(calculator(12, 12, 12, 100, 100, 12)).toBe(4);
});

test('calulates monthly cost with all inputs car has -12 depreciation', () => {
...
test('calulates monthly cost with all inputs car has -5000 depreciation', () => {
